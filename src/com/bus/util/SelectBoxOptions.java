...
public class SelectBoxOptions {
	...
	public static List<SelectBoxOption> getUsers(List<Account> accounts) {
		List<SelectBoxOption> list = new ArrayList<SelectBoxOption>();
		for(Account a:accounts){
			SelectBoxOption s = new SelectBoxOption(a.getUsername(),a.getId()+"");
			list.add(s);
		}
		return list;
	}

	public static List<SelectBoxOption> getGroups(List<Groups> groups) {
		List<SelectBoxOption> list = new ArrayList<SelectBoxOption>();
		for(Groups a:groups){
			SelectBoxOption s = new SelectBoxOption(a.getName(),a.getId()+"");
			list.add(s);
		}
		return list;
	}

	public static List<SelectBoxOption> getActions(List<Action> groupActions) {
		List<SelectBoxOption> list = new ArrayList<SelectBoxOption>();
