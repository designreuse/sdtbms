...
<!-- 				The Form to submit new coordinate data -->
				<stripes:form id="form_new_coordinate" beanclass="com.bus.stripes.actionbean.HRCoordinatorActionBean" focus="">
					...
					<table>
						...
						<tr>
							<td>姓名:</td><td><stripes:text name="coordinate.employee.fullname"/></td>
							<td>工号:</td><td><stripes:text name="coordinate.employee.workerid"/></td>
						</tr>
						<tr>
						...
						<tr>
							<td>工资停发日:</td><td><stripes:text name="coordinate.movedate"  formatPattern="yyyy-MM-dd" class="datepickerClass"/></td>
							<td>新工资发放日:</td><td><stripes:text name="coordinate.activedate"  formatPattern="yyyy-MM-dd" class="datepickerClass"/></td>
						</tr>
						<tr>
				...
				<table>
					...
					<c:forEach items="${actionBean.coordinates}" var="coor" varStatus="loop">
						<c:choose>
							...
							<td>${coor.movedate}</td>
							<td>${coor.activedate}</td>
							<td>${coor.remark}</td>
							<td>${coor.createdate}</td>
						</tr>
