					...
					<ss:secure roles="score_approve_submit_items">
						...
						<c:if test="${actionBean.mode<0 }">
							...
							<stripes:form beanclass="com.bus.stripes.actionbean.score.ScoreApproveActionBean" method="get">
								<input type="hidden" name="preapprove" value=""/>
								...
								&nbsp;|&nbsp;
								<br/>
								起始日期:<stripes:text name="startDate" class="datepickerClass"/>&nbsp;&nbsp;
								结束日期:<stripes:text name="endDate" class="datepickerClass"/>&nbsp;&nbsp;
								<button name="selectPeriod" value="a">按时间段搜索</button>
							</stripes:form>
							</div>
