					...
					<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
						...
						<div class="portlet-content">
							<ul id="style-switcher" class="side-menu">
								...
								<li>
									<a href="${pageContext.request.contextPath}/actionbean/Scorehome.action" title="积分主页">批量积分添加/删除</a>
								</li>
								<li>
								...
								<li>
									<a href="${pageContext.request.contextPath}/actionbean/Scorehome.action" title="积分主页">积分排名查看</a>
								</li>
							</ul>
						</div>
					</div>
