					...
					<div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
						...
						<div class="portlet-content">
							<ul id="style-switcher" class="side-menu">
								<li>
									<a class="set_theme" id="black_rose" href="${pageContext.request.contextPath}/actionbean/Employee.action" title="档案查看">档案管理</a>
								</li>
								<li>
									<a class="set_theme" id="gray_standard" href="${pageContext.request.contextPath}/actionbean/Department.action" title="部门查看">部门管理</a>
								</li>
								<li>
									<a class="set_theme" id="gray_lightness" href="${pageContext.request.contextPath}/actionbean/Position.action" title="职位查看">职位管理</a>
								</li>
								<li>
									<a class="set_theme" id="apple_pie" href="${pageContext.request.contextPath}/actionbean/Contract.action" title="职位查看">合同管理</a>
								</li>
								<li>
									<a class="set_theme" id="blueberry" href="${pageContext.request.contextPath}/actionbean/HRCoordinator.action" title="升迁/调度/离职">升迁/调度/离职</a>
								</li>
							</ul>
						</div>
					</div>
