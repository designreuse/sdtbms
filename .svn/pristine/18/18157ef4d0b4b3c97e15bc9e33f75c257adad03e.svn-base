					...
					<stripes:form beanclass="com.bus.stripes.actionbean.ContractActionBean" focus="">
						...
						<tr>
							<td colspan=9 style="text-align:left">
								...
								不限日期:<stripes:radio name="contractselector.dateselector" value="0"/> 结束日期:<stripes:radio name="contractselector.dateselector" value="1"/> 生效日期:<stripes:radio name="contractselector.dateselector" value="2"/>
						</tr>
