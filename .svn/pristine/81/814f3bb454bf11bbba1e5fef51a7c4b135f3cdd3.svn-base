    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/hr.js"></script>
		...
		<!-- Side bar ****************************************************************** -->
				...
				<stripes:form id="file_submit_form" beanclass="com.bus.stripes.actionbean.EmployeeActionBean">
					...
					<br/><Label>调动文件csv:</Label><stripes:file name="coordinatorfile" id="file_coordinator"/><stripes:submit name="coordinatorfileupload" value="提交"/>
...
<%-- 								年龄:<stripes:text name="employeeselector.age"/> --%>
						...
						<tr>
							<td colspan=11 style="text-align:left">
								...
								<br/>
								<stripes:submit name="filter" value="提交"/><stripes:submit name="downloadcurrentform" value="下载当前选项表单"/>
							</td>
						</tr>
					</stripes:form>
						<tr>
